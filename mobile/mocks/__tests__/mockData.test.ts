...
describe('Mock Data - Clientes', () => {
  ...
  it('each cliente should have required fields', () => {
    MOCK_CLIENTES.forEach((cliente) => {
      ...
      expect(cliente.domicilios).toBeDefined();
      expect(cliente.domicilios.length).toBeGreaterThan(0);
      expect(cliente.domicilios[0].calle).toBeTruthy();
      expect(cliente.domicilios[0].numero).toBeTruthy();
      expect(cliente.domicilios[0].latitud).toBeDefined();
      expect(cliente.domicilios[0].longitud).toBeDefined();
      expect(cliente.domicilios[0].dias.length).toBeGreaterThan(0);
      expect(cliente.domicilios[0].dias[0].nombre).toBeDefined();
      expect(cliente.domicilios[0].dias[0].horarios.length).toBeGreaterThan(0);
      expect(cliente.domicilios[0].dias[0].horarios[0].inicio).toBeTruthy();
